...
class FlaskTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        the_application.signup("homie@gmail.com", "duff")
    ...
    def test_signup(self):
        ...
        with self.tester as the_tester:
            the_tester.post("/signup", data=dict(email="marge_s@gmail.com", password="maggie"),
                            follow_redirects=True)
            self.assertEqual(
                "marge_s@gmail.com", session['email'],
                msg="The session should contain a email `marge_s@gmail.com`")

    def test_login(self):
        """This method tests if the application logs in users correctly"""
        with self.tester as the_tester:
            the_tester.post("/login", data=dict(email="homie@gmail.com", password="duff"),
                            follow_redirects=True)
            self.assertTrue(the_application.logged_in["homie@gmail.com"],
                            msg="The session user `homie@gmail.com` should be logged in")
    ...
    def test_logout(self):
        ...
        with self.tester as the_tester:
            ...
            self.assertFalse(the_application.logged_in["homie@gmail.com"],
                             msg="The session user `homie@gmail.com` should be logged out")
    ...
    def test_create_shopping_list(self):
        ...
        with self.tester as the_tester:
            ...
            self.assertIn("List 1", the_application.get_all_lists("homie@gmail.com").keys(),
        ...
        with self.tester as the_tester:
            ...
            the_tester.post("/edit_shopping_list",
                            data=dict(old_title="List 1",
                                      new_title="New List"),
                            follow_redirects=True)
            self.assertIn("New List", the_application.get_all_lists("homie@gmail.com").keys(),
                          msg="There should be a list named `List 1` in the user lists")
            self.assertNotIn("List 1", the_application.get_all_lists("homie@gmail.com").keys(),
                             msg="There should be a list named `List 1` in the user lists")
    ...
    def test_add_item(self):
        ...
        with self.tester as the_tester:
            ...
            self.assertIn("Item 1", the_application.users["homie@gmail.com"].shopping_lists["List 1"].items.keys(),
    ...
    def test_edit_item(self):
        ...
        with self.tester as the_tester:
            ...
            the_tester.post("/edit_item",
                            ...
                            follow_redirects=True)
            self.assertIn("New Item", the_application.users["homie@gmail.com"].shopping_lists["List 1"].items.keys(),
                          msg="There should be an item named `New Item` in the user list items")
            self.assertNotIn("Item 1", the_application.users["homie@gmail.com"].shopping_lists["List 1"].items.keys(),
    ...
    def test_check_item_toggle(self):
        ...
        with self.tester as the_tester:
            ...
            the_tester.get("/check_item_toggle?list_title='List 1'&name='Item 1'&new_status='false'",
                           follow_redirects=True)
            self.assertFalse(the_application.users["homie@gmail.com"].shopping_lists["List 1"].items["Item 1"].status,
