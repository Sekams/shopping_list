...
class TestShoppingListApplication(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_1 = User('homie@gmail.com', 'duff', {})
        self.user_2 = User('marge@gmail.com', 'maggie', self.shopping_lists)
    ...
    def test_signup(self):
        ...
        self.application.signup(self.user_1.email, self.user_1.password)
        self.assertTrue("homie@gmail.com" in self.application.users.keys(),
                        msg='The object should contain the user `homie@gmail.com`')

    def test_login(self):
        """This method tests if the class successfully signs in users"""
        self.application.signup(self.user_1.email, self.user_1.password)
        self.application.login(self.user_1.email, self.user_1.password)
        self.assertTrue("homie@gmail.com" in self.application.logged_in.keys(),
                        msg='The object should contain the user `homie@gmail.com`')
        self.assertTrue(self.application.logged_in["homie@gmail.com"],
                        msg='The user `homie@gmail.com` should be logged in')

    def test_logout(self):
        """This method tests if the class successfully signs out users"""
        self.application.signup(self.user_1.email, self.user_1.password)
        self.application.login(self.user_1.email, self.user_1.password)
        self.application.logout(self.user_1.email)
        self.assertTrue("homie@gmail.com" in self.application.logged_in.keys(),
                        msg='The object should contain the user `homie@gmail.com`')
        self.assertFalse(self.application.logged_in["homie@gmail.com"],
                         msg='The user `homie@gmail.com` should be logged out')
    ...
    def test_create_shopping_list(self):
        ...
        self.application.create_shopping_list(
            "Homers shopping list", self.user_1.email)
        self.assertTrue("Homers shopping list" in self.application.users[self.user_1.email].shopping_lists.keys(),
    ...
    def test_edit_shopping_list(self):
        ...
        self.application.edit_shopping_list(
            "Homers shopping list", "List 1", self.user_1.email)
        self.assertTrue("List 1" in self.application.users[self.user_1.email].shopping_lists.keys(),
                        msg='The object should contain the list `List 1`')
        self.assertFalse("Homers shopping list" in self.application.users[self.user_1.email].shopping_lists.keys(),
    ...
    def test_share_shopping_list(self):
        ...
        self.application.share_shopping_list(
            "Homers shopping list", self.user_1.email)
        self.assertTrue("Homers shopping list" in self.application.sharing_pool[self.user_1.email].keys(),
                        msg='The object should contain the list `Homers shopping list`')
    ...
    def test_add_item(self):
        ...
        self.application.add_item(
            self.item_1.name, "Homers shopping list", self.item_1.price, self.user_1.email)
        self.assertTrue("Tooth paste" in self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items.keys(),
    ...
    def test_edit_item(self):
        ...
        self.application.edit_item(
            "Homers shopping list", self.item_1.name, "Coffee", 9000, self.user_1.email)
        self.assertTrue("Coffee" in self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items.keys(),
                        msg='The object should contain the item `Coffee`')
        self.assertFalse("Tooth paste" in self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items.keys(),
    ...
    def test_remove_item(self):
        ...
        self.application.remove_item(
            "Homers shopping list", "Tooth paste", self.user_1.email)
        self.assertFalse("Tooth paste" in self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items.keys(),
                         msg='The object should not contain the item `Tooth paste`')
    ...
    def test_check_item_toggle(self):
        ...
        self.application.check_item_toggle(
            "Homers shopping list", self.item_1.name, True, self.user_1.email)
        self.assertTrue(self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items["Tooth paste"].status,
                        msg='The object status should be True')
        self.application.check_item_toggle(
            "Homers shopping list", self.item_1.name, False, self.user_1.email)
        self.assertFalse(self.application.users[self.user_1.email].shopping_lists["Homers shopping list"].items["Tooth paste"].status,
    ...
    def test_get_all_lists(self):
        ...
        self.application.share_shopping_list(
            "Homers shopping list", self.user_1.email)
        self.application.signup(self.user_2.email, self.user_2.password)
        self.assertTrue("Homers shopping list" in self.application.get_all_lists(self.user_2.email).keys(),
                        msg='The object should contain the list `Homers shopping list`')
