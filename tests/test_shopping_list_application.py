...
class TestShoppingListApplication(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_1 = User('homie', 'homie@gmail.com', 'duff', {})
        self.user_2 = User('marge', 'marge@gmail.com', 'maggie', self.shopping_lists)
    ...
    def test_signup(self):
        ...
        self.application.signup(self.user_1.username, self.user_1.email, self.user_1.password)
